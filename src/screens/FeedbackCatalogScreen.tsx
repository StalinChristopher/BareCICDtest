...
export function FeedbackCatalogScreen() {
  ...
  const showAutoDismissSnackbar = (type: "success" | "error" | "warning" | "info") => {
  ...
  const showSingleButtonAlert = (type: "success" | "error" | "warning" | "info") => {
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top", "left", "right"]}>
      ...
      <View style={styles.buttonContainer}>
        ...
        >
          <Text style={styles.buttonText}>Auto Dismiss Snackbar - Success</Text>
        </Pressable>
