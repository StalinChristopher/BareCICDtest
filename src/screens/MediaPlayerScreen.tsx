...
import type { MainTab, PlaybackMode } from "./mediaPlayerScreen/mediaPlayerScreen.types";
...
export function MediaPlayerScreen() {
  ...
  return (
    <View style={layoutStyles.root}>
      <MediaPlayerTabBar mainTab={mainTab} onSelect={setMainTab} styles={layoutStyles} />
