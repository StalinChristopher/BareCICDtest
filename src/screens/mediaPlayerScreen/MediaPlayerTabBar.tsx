...
export function MediaPlayerTabBar({ mainTab, onSelect, styles }: MediaPlayerTabBarProps) {
  return (
    <View style={styles.tabRow}>
      ...
      >
        <Text style={[styles.tabBtnText, mainTab === "player" && styles.tabBtnTextActive]}>
          Player
        </Text>
      </Pressable>
      <Pressable
      ...
      >
        <Text
          style={[styles.tabBtnText, mainTab === "downloads" && styles.tabBtnTextActive]}
        >
          Downloads
        </Text>
      </Pressable>
